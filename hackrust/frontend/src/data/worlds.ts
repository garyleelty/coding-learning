...
export const worlds: World[] = [
  {
    ...
    levels: [
      ...
      },
      {
        ...
        title: '第一个程序',
        type: 'code',
        lesson: 'println! 把文字显示到屏幕上。文字放在英文双引号里。试试改文字内容，看输出怎么变。',
      ...
      },
      {
        ...
        title: '输出多行',
        type: 'code',
        lesson: '每写一个 println! 就输出一行。试试加一行、改一行、删一行，看输出怎么变。',
      ...
      },
      {
        ...
        title: '用变量存储数据',
        type: 'code',
        lesson: 'let x = 5; 创建变量。println!(“{}”, x) 中 {} 会被变量值替换。试试改 x 的值。',
  ...
  },
  {
    ...
    levels: [
      ...
      },
      {
        ...
        title: '可变变量',
        type: 'code',
        lesson: '加 mut 让变量可变，之后可以修改。试试去掉 mut 看会怎样（会报错）。',
    ...
    levels: [
      {
        ...
        title: '算术运算',
        type: 'code',
        lesson: '+、-、*、/、% 五种运算。试试改数字，看结果怎么变。注意整数相除会丢小数。',
    ...
    levels: [
      {
        ...
        title: 'if 条件判断',
        type: 'code',
        lesson: 'if 判断条件，true 执行 if 块，false 执行 else 块。试试改 x 的值。',
      ...
      },
      {
        ...
        title: 'for 循环',
        type: 'code',
        lesson: 'for 循环遍历范围。0..5 是 0-4，0..=5 是 0-5。试试改范围看输出变化。',
